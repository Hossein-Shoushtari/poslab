...
def callback(
    ...
    # =========== CANVAS ============
    # UPLOAD
    if 'help_btn' in button: return modal_state, no_update, not help_state     # activate upload offcanvas
    #============= MAP =============
        ...
        for i in range(len(map_filenames)):
            ...
            else: return not modal_state, no_update, help_state # activating modal -> warning    
        # if everything went fine ...
        return modal_state, get_map(), help_state # returning an html.Iframe with refreshed map
    # ========== WAYPOINTS ==========
        ...
        # if everything went fine ...
        return modal_state, no_update, help_state
    # ========== ANTENNAS ===========
    ...
    else: return modal_state, get_map(), help_state # returning the current Iframe/map
